...
public class ViewToController {
	...
	@RequestMapping(value = "/transfer4" , method = RequestMethod.POST) // 5번 보다는 4번예시를 권장
	...
	public String transfer5(String id, String pw, String name) { // 넘어오는 데이터의 name과 변수명이 동일해야함.
